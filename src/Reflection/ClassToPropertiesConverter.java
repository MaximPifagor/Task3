...
//            }
    ...
    protected static class Coder
    {
        ...
        protected Properties toProperties(Object obj)
        {
            ...
            String strMainObjecID = storeObject(obj);
            m_propData.put("mainObjectID", String.valueOf(strMainObjecID));
            return m_propData;
        }
        ...
        private String storeObjectImpl(Object obj)
        {
            if (obj == null)
            {
                // reserve 0 to represent null references
                return null;
            }
    ...
    protected static class Decoder
    {
        ...
        protected Object fromProperties(Properties prop)
        {
            ...
            String strMainObjecID = (String)m_propData.get("mainObjectID");
            return restoreObject(strMainObjecID);
        }
